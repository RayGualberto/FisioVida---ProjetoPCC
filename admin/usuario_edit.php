...
<form method="post" class="card shadow-sm p-3">
  <div class="row g-3">
    ...
    <div class="col-md-3">
      ...
      <input type="text" name="cpf" class="form-control" value="<?php echo htmlspecialchars($cpf); ?>" required maxlength="14">
    </div>
    ...
    <div class="col-md-3">
      ...
      <input type="text" name="cep" class="form-control" value="<?php echo htmlspecialchars($cep); ?>" required>
    </div>
